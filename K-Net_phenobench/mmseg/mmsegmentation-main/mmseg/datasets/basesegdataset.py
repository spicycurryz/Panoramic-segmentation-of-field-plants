...
class BaseSegDataset(BaseDataset):
    ...
    def load_data_list(self) -> List[dict]:
        ...
        print("load_data_list baseseg 000000000000000000000")  # this
        ...
        if not osp.isdir(self.ann_file) and self.ann_file:
            ...
            # print("if 1 ")
            # print(fileio.list_dir_or_file , "  fileio.list_dir_or_file")
...
class BaseCDDataset(BaseDataset):
    ...
    def load_data_list(self) -> List[dict]:
        print("load_data_list baseseg 000000000000000000000")
        """Load annotation from directory or annotation file.
