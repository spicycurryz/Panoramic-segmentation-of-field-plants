...
class KernelIterHead(BaseRoIHead):
    ...
    def forward_train(self,
        ...
        for stage in range(self.num_stages):
            ...
            # print(stage,"77777777777777stage")  # 0
            # print(cls_score.size(),"77777777777777cls_score.size()") # torch.Size([2, 100, 5]) 
            ...
            # print(type(self.mask_head[stage]),"  self.mask_head[stage]")  # <class 'knet.det.kernel_update_head.KernelUpdateHead'>
            # print(type(self.mask_head),"  self.mask_head") # <class 'torch.nn.modules.container.ModuleList'> 
            mask_targets = self.mask_head[stage].get_targets(  #this
                sampling_results,
                gt_masks,
                gt_labels,
            ...
            # print(cls_score.size(),type(mask_targets),type(mask_targets[0]),mask_targets[0].size(),"66666666666666666")  #   torch.Size([2, 100, 5]) <class 'tuple'> <class 'torch.Tensor'> torch.Size([206]) 66666666666666666
 
            single_stage_loss = self.mask_head[stage].loss(   # this
                object_feats,
                cls_score,
                scaled_mask_preds,
                *mask_targets,
