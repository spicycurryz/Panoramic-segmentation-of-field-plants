...
class KernelUpdateHead(nn.Module):
    ...
    def __init__(self,
                 ...
                 num_thing_classes=3,
                 num_stuff_classes=0,  # this  yes this
        ...
        # print(self.num_stuff_classes ,"  self.num_stuff_classes  KernelUpdateHead")  # 53
        # aaa
    ...
    def loss(self,
        ...
        if cls_score is not None:
            if cls_score.numel() > 0:
                # print(cls_score.view(num_preds, -1).size(),labels.size(),"   cls_score.view(num_preds, -1),labels  555555555555555555555")  # torch.Size([200, 5]) torch.Size([206]) 
    ...
    def _get_target_single(self, pos_inds, neg_inds, pos_mask, neg_mask,
        ...
        if gt_sem_cls is not None and gt_sem_seg is not None:
            ...
            # print(sem_thing_weights.size(),sem_stuff_weights.size(),"222")  # torch.Size([53, 80]) torch.Size([53, 53]) 222
            ...
            # print(self," 222")
            # print(label_weights.size(),sem_label_weights.size(),"1111")  # torch.Size([100, 5]) torch.Size([53, 133]) 
    ...
    def get_targets(self,
        ...
        # print(
        #     pos_inds_list      [0].size()      ,
        #     neg_inds_list      [0].size()      ,
        #     pos_mask_list      [0].size()      ,
        #     neg_mask_list      [0].size()      ,
        #     pos_gt_mask_list   [0].size(),
        #     pos_gt_labels_list [0].size(),
        #     gt_sem_seg         [0].size()        ,
        #     gt_sem_cls         [0].size()        ,
        #     "77777777777777799999999999"
        # )
        labels, label_weights, mask_targets, mask_weights = multi_apply(  #this
            ...
            gt_sem_cls,
            cfg=rcnn_train_cfg)
        # print(len(labels),"  labels.size() 777778")  # 2 
        # print(labels[0].size(),"  labels.size() 777778")  # 2   torch.Size([103]) 
        # print(labels[1].size(),"  labels.size() 777778")  # 2   torch.Size([103]) 
        if concat:
