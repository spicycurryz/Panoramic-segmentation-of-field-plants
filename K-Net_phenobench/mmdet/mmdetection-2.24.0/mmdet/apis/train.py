...
def train_detector(model,
    ...
    # print(runner , "  runner")  # mmcv.runner.epoch_based_runner.EpochBasedRunner object 
    # print(data_loaders , "  data_loaders")  # torch.utils.data.dataloader.DataLoader 
    # print(type(cfg),"  cfg")  # <class 'mmcv.utils.config.Config'> 
    # print("  #############################################################")
    # print(type(cfg.workflow),"  cfg.workflow")  # <class 'list'> 
    # print(cfg.workflow,  "   cfg.workflow")
    # print(cfg,  "   cfg")

    # print("  #############################################################")

    runner.run(data_loaders, cfg.workflow)  # this
